...
import io.micrometer.core.instrument.Counter;  // <-- НОВЫЙ ИМПОРТ
...
public class BookingController {
    ...
    @Autowired
    private Counter bookingsCounter;  // <-- НОВОЕ ПОЛЕ
    ...
    public void bookHotel(@Valid @RequestBody BookHotelReq bookHotelReq)
        ...
        bookingsCounter.increment();  // <-- увеличиваем счётчик бронирований
    }
